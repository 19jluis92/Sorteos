...
public class Brain {
    ...
    public String amigosMelate(int sorteoId, Date inicio, Date fin) {
        ...
        result = this.completeNumber("" + pos1, 2) + "," + this.completeNumber("" + pos2, 2) + ","
                + this.completeNumber("" + pos3, 2) + "," + this.completeNumber("" + pos4, 2) + ","
                + this.completeNumber("" + pos5, 2) + "," + this.completeNumber("" + pos6, 2);
        if (listTemp.size() > 1) {

...
```
//TODO Algoritmo1 no se usa no se ideo la manera correcta de usar las variables estadisticas
...
is not used, the correct way to use the statistical variables was not devised
